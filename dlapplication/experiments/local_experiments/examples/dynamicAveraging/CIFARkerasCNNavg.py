...
if __name__ == "__main__":
    ...
    stoppingCriterion = MaxAmountExamples(1400) #2800
    ...
    learnerFactory = KerasLearnerFactory(network=CIFAR100Network(), updateRule=updateRule, learningRate=learningRate, lossFunction=lossFunction, batchSize=batchSize, syncPeriod=syncPeriod, delta=delta, aggType='average')
